...
public class Drawing extends Applet implements Runnable, KeyListener
{
	...
	public void init()
	{
		...
		//battlelord = new Sprite(100, 100, "../bad_", 5, 10);
		...
		//greenguy = new Sprite(100, 100, "../g", 5, 10);
		greenguy = new Sprite(200, 200, "../SP/g", 5, 10, action);
	...
	public void run()
	{
		while(true)
		{ 
			if(leftPressed)				greenguy.moveLeftBy(1);
			if(rightPressed)			greenguy.moveRightBy(1);
			if(upPressed)				greenguy.moveUpBy(1);
			if(downPressed)				greenguy.moveDownBy(1);
